...
(() => {
  ...
  const I18N = {
    en: {
      ...
      exampleDelta: '+8 h 02 min after last Amoxicillin',
      ...
      sumMedAvg: (delta) => `avg every ${delta}`,
    ...
    hr: {
      ...
      exampleDelta: '+8 h 02 min nakon zadnjeg Amoksicilina',
      ...
      sumMedAvg: (delta) => `u prosjeku svakih ${delta}`,
      sumMedLongest: (delta) => `najduži razmak ${delta}`,
      sumMedPlan: (n) => `plan: svakih ${n} h`,
